...
function Run(){
    // get the corners by creating functions which select an item from the data which has the correct val
    ...
    console.log("Bounding box computed for hallehimes@tamu.edu: ");
